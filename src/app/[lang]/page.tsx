...
import { CuppingResult } from '@/commons/types/type';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-lg p-8 bg-white shadow-md rounded-md">
        ...
        <p className="text-lg text-gray-700 mb-4">ダッシュボードページへようこそ！</p>
        <p className="text-base text-gray-600">ここでは、カッピングアプリのダッシュボード機能を利用できます。カッピングの履歴を閲覧したり、プロフィール情報を編集したりすることができます。</p>
        <Link href="/ja/cupping" className="mt-4 inline-block bg-blue-500 text-white px-4 py-2 rounded-md transition duration-300 hover:bg-blue-600">
          カッピングを始める
        </Link>
