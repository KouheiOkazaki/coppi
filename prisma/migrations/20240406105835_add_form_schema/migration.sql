...
-- CreateTable
CREATE TABLE "CoeFormList" (
    "id" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "CoeFormList_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "CoeFormData" (
    "id" TEXT NOT NULL,
    "sampleNo" TEXT NOT NULL,
    "roastLevel" TEXT NOT NULL,
    "aroma" DOUBLE PRECISION NOT NULL,
    "defects" DOUBLE PRECISION NOT NULL,
    "cleanCup" DOUBLE PRECISION NOT NULL,
    "sweet" DOUBLE PRECISION NOT NULL,
    "acidity" DOUBLE PRECISION NOT NULL,
    "mouthfeel" DOUBLE PRECISION NOT NULL,
    ...
    CONSTRAINT "CoeFormData_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "CoeFormData" ADD CONSTRAINT "CoeFormData_coeFormList_id_fkey" FOREIGN KEY ("coeFormList_id") REFERENCES "CoeFormList"("id") ON DELETE SET NULL ON UPDATE CASCADE;
